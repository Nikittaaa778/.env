...
my_variable = """Привет, %friend_name%! %my_name% приглашает тебя на сайт %website%!
%website% — это новая версия онлайн-курса по программированию. 
Изучаем Python и не только. Решаем задачи. Получаем ревью от преподавателя. 
Как будет проходить ваше обучение на %website%? 
...
Регистрируйся → %website%  
На курсы, которые еще не вышли, можно подписаться и получить уведомление о релизе сразу на имейл."""
my_variable= my_variable.replace('%website%',"https://dvmn.org/referrals/cKHsKjCwFJ2huOZkBILdnm3osBAMhU40ZgaK0ypx/")
my_variable= my_variable.replace('%friend_name%',"Александр")
my_variable= my_variable.replace('%my_name%',"Никита")
